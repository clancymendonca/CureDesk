/** Wide-model symptom feature keys (rf-v3.0-wide / kaushil268). */
export const SYMPTOM_FEATURES = [
  "itching",
  "skin_rash",
...
export type SymptomFeatureKey = (typeof SYMPTOM_FEATURES)[number];

/** Keys mapped from the 4 quick toggles — hide from advanced list to avoid duplicates. */
export const LEGACY_WIDE_SYMPTOMS = new Set([
  "cough",
  "fatigue",
  "high_fever",
  "mild_fever",
